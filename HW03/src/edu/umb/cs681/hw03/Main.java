...
public class Main {
	...
	public static void main(String[] args) throws Exception {
        ...
        var path = Paths.get("src/edu/umb/cs681/hw03/data/pvi_results.csv");

        // Finding my neighbouring counties
        var neighbouringCounties = Files.readAllLines(path)
                .stream()
                .filter(line -> line.contains("Massachusetts, Hampden")
                        ...
                        || line.contains("Massachusetts, Berkshire")
                        || line.contains("Rhode Island, Hampshire"))
                .map(line -> line.split(","))
