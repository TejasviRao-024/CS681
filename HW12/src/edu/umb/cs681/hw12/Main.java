...
public class Main {
	...
	public static void main(String[] args) {
        ...
        Directory dr1 = new Directory(null, "Root", 10, date);
        Directory dr2 = new Directory(dr1, "Home", 7, date);
        Directory dr3 = new Directory(dr1, "User", 4, date);

        File f1 = new File(dr2, "Main.java", 4, date);
        File f2 = new File(dr2, "Sub File.java", 6, date);
        File f3 = new File(dr2, "User Settings.json", 10, date);
